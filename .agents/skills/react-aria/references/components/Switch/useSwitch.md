...
|------|------|-------------|
| `descriptionProps` \* | `DOMAttributesWithRef<HTMLElement>` | Props for the switch description element, if any. |
| `errorMessageProps` \* | `DOMAttributesWithRef<HTMLElement>` | Props for the switch error message element, if any. |
