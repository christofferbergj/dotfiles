...
| `calendarProps` \* | `CalendarProps<DateValue, "single">` | Props for the calendar within the popover dialog. |
...
| `labelProps` \* | `DOMAttributes<FocusableElement>` | Props for the date picker's visible label element, if any. |
